...
3. 실행이 완료되면 `%Core repository%/build/libs/` 폴더에 `did-zkp-sdk-server-1.0.0.jar` 파일을 생성된다.

<br>

## SDK 적용 방법
1. 앱 프로젝트의 libs에 did-zkp-sdk-server-1.0.0.jar, did-crypto-sdk-server-1.0.0.jar 파일을 복사한다.
